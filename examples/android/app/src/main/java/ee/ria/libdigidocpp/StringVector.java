...
public class StringVector extends java.util.AbstractList<String> implements java.util.RandomAccess {
  ...
  public StringVector(StringVector other) {
    this(digidocJNI.new_StringVector__SWIG_1(StringVector.getCPtr(other), other), true);
  }
  ...
  public StringVector(int count, String value) {
    this(digidocJNI.new_StringVector__SWIG_2(count, value), true);
  }

  private int doSize() {
    return digidocJNI.StringVector_doSize(swigCPtr, this);
  }

  private void doAdd(String x) {
    digidocJNI.StringVector_doAdd__SWIG_0(swigCPtr, this, x);
  }

  private void doAdd(int index, String x) {
    digidocJNI.StringVector_doAdd__SWIG_1(swigCPtr, this, index, x);
  }

  private String doRemove(int index) {
    return digidocJNI.StringVector_doRemove(swigCPtr, this, index);
  }

  private String doGet(int index) {
    return digidocJNI.StringVector_doGet(swigCPtr, this, index);
  }

  private String doSet(int index, String val) {
    return digidocJNI.StringVector_doSet(swigCPtr, this, index, val);
  }

  private void doRemoveRange(int fromIndex, int toIndex) {
    digidocJNI.StringVector_doRemoveRange(swigCPtr, this, fromIndex, toIndex);
  }
