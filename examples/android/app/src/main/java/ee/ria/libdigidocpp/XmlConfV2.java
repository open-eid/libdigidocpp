...
public class XmlConfV2 extends ConfV2 {
  ...
  public static XmlConfV2 instance() {
    long cPtr = digidocJNI.XmlConfV2_instance();
    return (cPtr == 0) ? null : new XmlConfV2(cPtr, false);
  }
  ...
  public void setTSUrl(String url) {
    digidocJNI.XmlConfV2_setTSUrl(swigCPtr, this, url);
  }
